...
class InlineInformationHolder extends QuickfixSemanticModification {
	private String type; 
	
	public InlineInformationHolder(String type) {
		this.type = type;
	}
	...
	public void performQuickfix(EObject element, IModificationContext context) {
		...
		if(type.equals("fromRequest")) {
			MessageTransformations.inlineInformationHolder((Operation)element, true);
		} else if (type.equals("fromResponse")) {
			MessageTransformations.inlineInformationHolder((Operation)element, false);
		} else {
