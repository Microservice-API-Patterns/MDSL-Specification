...
public class MAPDecoratorValidator extends AbstractMDSLValidator {
	...
	public void checkRoleResponsibilityPatternCombination(EndpointContract nextEndpoint) {
		...
		// TODO (L) could also look at "other roles"

		if (role1 == null || role1.equals("")) {
			info(nextEndpoint.getName() + " has no responsibility ", nextEndpoint, ApiDescriptionPackage.eINSTANCE.getEndpointContract_Name()); // Literals.ENDPOINT_CONTRACT__NAME);
	...
	// could refactor this one, was adapted from generator/converter:
