...
package ${findPackageNameInJavaBinding()};
...
<#elseif techBinding.protBinding2.http??><#return "HTTP">
<#elseif techBinding.protBinding2.grpc??><#return "GRPC">
<#elseif techBinding.protBinding2.other??><#return "other">
<#else><#return apiName>
</#if>
</#list>
</#list>
