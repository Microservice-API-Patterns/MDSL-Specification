...
/**
 * A simple example that illustrates how to use the MDSL generators. In this case the Jolie generator.
 *
 * @author Stefan Kapferer
 */
public class JolieGeneration {
    ...
    public static void main(String[] args) {
        ...
        // call the generator
        mdslAPI.callGenerator(mdsl, new JolieGenerator());

        // hint: in case you want to generate into another folder than "./src-gen", use the following call:
        // mdslAPI.callGenerator(mdsl, new JolieGenerator(), "./out-dir");
    }
